...
> **Persistence Is Not Accumulation: Erasure, Suppression, and Re-instatement in Online In-Weight Memory for Language Models** (v2 preprint, July 2026 — [paper/inweight_stream_v2.pdf](paper/inweight_stream_v2.pdf), doi:10.5281/zenodo.21232648)
...
reproduce.sh          # the full run matrix (~94 runs × ~5–8 min on one 24GB GPU)
```
